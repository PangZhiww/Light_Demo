...
class UserInfo(models.Model):
    username = models.CharField(verbose_name='用户名', max_length=64, db_index=True)  # db_index=True 索引
...
class Project(models.Model):
    ...
    name = models.CharField(verbose_name='项目名', max_length=256)
    color = models.SmallIntegerField(verbose_name='颜色', choices=COLOR_CHOICES, default=1)
    desc = models.CharField(verbose_name='项目描述', max_length=1024, null=True, blank=True)
    ...
    bucket = models.CharField(verbose_name='cos桶', max_length=2048)
    region = models.CharField(verbose_name='cos区域', max_length=1024)
...
class FileRepository(models.Model):
    ...
    key = models.CharField(verbose_name='文件储存在COS中的KEY', max_length=256, null=True, blank=True)

    # int类型最大表示的数据
    file_size = models.BigIntegerField(verbose_name='文件大小', null=True, blank=True, help_text='字节')

    file_path = models.CharField(verbose_name='文件路径', max_length=1024, null=True,
